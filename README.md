...
The GUI mirrors the agent's state (all via the same `config.json`): a **模型 chip** (top-right, click to cycle 默认/Sonnet/Opus/Haiku), and bottom-row **忘记闲聊** / **清空查询** / **授权用户** buttons.
